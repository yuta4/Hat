...
public class RequestValidationService {
    ...
    public void validate(Player player, Game game) {
        if(player != null && !player.equals(game.getOwner())) {
            throw new RequestValidationException(String.format("Check request owner and gameId failed: %s, %d",
                    player, game.getId()));
        }
    }
